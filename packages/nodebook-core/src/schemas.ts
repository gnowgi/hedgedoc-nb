...
export const nodeTypes: NodeTypeSchema[] = [
  ...
  { name: 'Agent', description: 'A person or company who participates in an economic event.', parent_types: ['class'] },
  {
    ...
    description: 'A node representing a logical condition like AND or OR.',
    parent_types: ['class']
  },
  ...
  {
    name: 'Function',
    description: 'A computable transition with a definition that evaluates input values to produce output values.',
    parent_types: ['Transition']
  },
  {
    name: 'Transaction',
    description: 'An accounting transaction that moves value between accounts (double-entry).',
    parent_types: ['class']
  },
  ...
  {
    name: 'Liability',
    description: 'An account representing obligations owed (credit-normal).',
    parent_types: ['Account']
  },
  {
    name: 'Equity',
    description: "An account representing owner's residual interest (credit-normal).",
    parent_types: ['Account']
  },
...
export const relationTypes: RelationTypeSchema[] = [
  ...
  },
  {
    ...
    description: 'Subsumption between two types/classes (e.g., "Human is a Mammal").',
    domain: ['class'],
    range: ['class'],
    symmetric: false,
    transitive: true,
  ...
  },
  {
    ...
    description: 'An individual belongs to a class (e.g., "Socrates is a member of Humans").',
    domain: ['individual'],
    range: ['class'],
    symmetric: false,
    transitive: false,
  ...
  },
  {
    ...
    description: 'An individual is an instance of a class (e.g., "Earth is an instance of Planet").',
    domain: ['individual'],
    range: ['class'],
    symmetric: false,
    transitive: false,
  ...
  {
    name: 'debit',
    description: 'Debits an account (increases assets/expenses, decreases liabilities/equity/revenue).',
    domain: ['Transaction'],
    range: ['Account', 'Asset', 'Liability', 'Equity', 'Revenue', 'Expense']
  },
  {
    name: 'credit',
    description: 'Credits an account (decreases assets/expenses, increases liabilities/equity/revenue).',
    domain: ['Transaction'],
    range: ['Account', 'Asset', 'Liability', 'Equity', 'Revenue', 'Expense']
  },
  {
...
export const attributeTypes: AttributeTypeSchema[] = [
  {
    name: 'charge',
    data_type: 'float',
    description: 'Measures electric charge. Example: An electron has a charge of -1.602e-19 C.',
    domain: ['Electron', 'Ion'],
    unit: 'coulomb (C)',
    allowed_values: null
  },
  {
    name: 'energy',
    data_type: 'float',
    description: 'Quantifies the capacity to do work. Example: A battery stores electrical energy.',
    domain: ['Particle', 'Field', 'Reaction'],
    unit: 'joule (J)',
    allowed_values: null
  },
  {
    name: 'mass',
    data_type: 'float',
    description: "Measures the amount of matter in an object. Example: Earth's mass is ~5.97e24 kg.",
    domain: ['Particle', 'Planet', 'Organism'],
    unit: 'kilogram (kg)',
    allowed_values: null
  },
  {
  ...
  },
  {
    name: 'temperature',
    data_type: 'float',
    description: 'Indicates thermal energy level. Example: Water boils at 373.15 K.',
    domain: ['Gas', 'Liquid', 'Solid'],
    unit: 'kelvin (K)',
    allowed_values: null
  },
  {
    name: 'velocity',
    data_type: 'float',
    description: 'Describes the rate of change of position. Example: A car moving at 60 km/h.',
    domain: ['Particle', 'Vehicle'],
  ...
  },
  {
    name: 'area',
    data_type: 'float',
    description: "Any place will have an attribute 'area'",
    domain: ['Place'],
    unit: null,
    allowed_values: null
  },
  {
    name: 'Alternate name',
    data_type: 'string',
    description: 'Any thing that is called by another name',
    unit: null,
    domain: [],
    allowed_values: null
  },
  {
    name: 'name',
    data_type: 'string',
    description: 'The primary name or title of an entity',
    unit: null,
    domain: [],
    allowed_values: null
  },
  {
    name: 'description',
    data_type: 'string',
    description: 'A detailed description or explanation of an entity',
    unit: null,
    domain: [],
    allowed_values: null
  },
  {
    name: 'identifier',
    data_type: 'string',
    description: 'A unique identifier or code for an entity',
    unit: null,
    domain: [],
    allowed_values: null
  },
  {
    name: 'url',
    data_type: 'string',
    description: 'A web address or link associated with an entity',
    unit: null,
    domain: [],
    allowed_values: null
  },
  {
    name: 'email',
    data_type: 'string',
    description: 'An email address associated with a person or organization',
    unit: null,
  ...
  },
  {
    name: 'founded_date',
    data_type: 'date',
    description: 'The date when an organization was established',
    unit: null,
    domain: ['Organization'],
    allowed_values: null
  },
  {
    name: 'start_date',
    data_type: 'date',
    description: 'The beginning date of an event or period',
    unit: null,
    domain: ['Event'],
    allowed_values: null
  },
  {
    name: 'end_date',
    data_type: 'date',
    description: 'The ending date of an event or period',
    unit: null,
    domain: ['Event'],
    allowed_values: null
  },
  ...
  },
  {
    name: 'width',
    data_type: 'float',
    description: 'The width dimension of an object',
    unit: 'meters',
    domain: ['Object'],
    allowed_values: null
  },
  {
    name: 'height',
    data_type: 'float',
    description: 'The height dimension of an object',
    unit: 'meters',
    domain: ['Object'],
    allowed_values: null
  },
  {
    name: 'depth',
    data_type: 'float',
    description: 'The depth dimension of an object',
    unit: 'meters',
    domain: ['Object'],
    allowed_values: null
  },
  ...
  },
  {
    name: 'color',
    data_type: 'string',
    description: 'The color of an object',
    unit: null,
    domain: ['Object'],
    allowed_values: null
  },
  {
    name: 'material',
    data_type: 'string',
    description: 'The material an object is made of',
    unit: null,
    domain: ['Object'],
    allowed_values: null
  },
  {
    name: 'status',
    data_type: 'string',
    description: 'The current status or state of an entity',
    unit: null,
    domain: [],
  ...
  },
  {
    name: 'type',
    data_type: 'string',
    description: 'The type or category of an entity',
    unit: null,
    domain: [],
    allowed_values: null
  },
  {
    name: 'category',
    data_type: 'string',
    description: 'A category or classification of an entity',
    unit: null,
    domain: [],
    allowed_values: null
  },
  {
    name: 'tag',
    data_type: 'string',
    description: 'A tag or label associated with an entity',
    unit: null,
    domain: [],
    allowed_values: null
  },
  {
    name: 'language',
    data_type: 'string',
    description: 'The language of a document or communication',
    unit: null,
    domain: ['Document'],
    allowed_values: null
  },
  {
    name: 'format',
    data_type: 'string',
    description: 'The format of a document or file',
    unit: null,
    domain: ['Document'],
    allowed_values: null
  },
  {
    name: 'size',
    data_type: 'number',
    description: 'The size of a file or document in bytes',
    unit: 'bytes',
    domain: ['Document'],
    allowed_values: null
  },
  {
    name: 'version',
    data_type: 'string',
    description: 'The version number of an entity',
    unit: null,
    domain: [],
    allowed_values: null
  },
  {
    name: 'author',
    data_type: 'string',
    description: 'The author or creator of a document or work',
    unit: null,
    domain: ['Document'],
    allowed_values: null
  },
  {
    name: 'publisher',
    data_type: 'string',
    description: 'The publisher of a document or work',
    unit: null,
    domain: ['Document'],
    allowed_values: null
  },
  ...
  },
  {
    name: 'price',
    data_type: 'float',
    description: 'The price or cost of an item',
    unit: 'currency',
    domain: ['Object'],
    allowed_values: null
  },
  {
    name: 'currency',
    data_type: 'string',
    description: 'The currency used for a price or monetary value',
    unit: null,
    domain: [],
  ...
  },
  {
    name: 'rating',
    data_type: 'float',
    description: 'A numerical rating or score',
    unit: null,
    domain: [],
    allowed_values: null
  },
  {
    name: 'score',
    data_type: 'float',
    description: 'A numerical score or grade',
    unit: null,
    domain: [],
    allowed_values: null
  },
  ...
  },
  {
    name: 'frequency',
    data_type: 'float',
    description: 'The frequency of occurrence or repetition',
    unit: 'hertz (Hz)',
    domain: [],
    allowed_values: null
  },
  {
    name: 'duration',
    data_type: 'float',
    description: 'The duration or length of time',
    unit: 'seconds',
    domain: ['Event'],
    allowed_values: null
  },
  ...
  },
  {
    name: 'volume',
    data_type: 'float',
    description: 'The volume of an object or container',
    unit: 'cubic meters',
    domain: ['Object'],
    allowed_values: null
  },
  {
    name: 'density',
    data_type: 'float',
    description: 'The density of a material',
    unit: 'kg/m^3',
    domain: ['Object'],
    allowed_values: null
  },
  {
    ...
    description: 'Attribute type used in the graph',
    data_type: 'string',
    unit: null,
    domain: [],
    allowed_values: null
  ...
  },
  {
    ...
    description:
      'A 3D position coordinates as a single data type. Example: A car at position (25.0, 15.0, 0.0) meters.',
    domain: ['Object', 'Particle', 'Vehicle'],
    unit: 'meters (m)',
    allowed_values: null,
    structure: {
  ...
  },
  {
    ...
    complex_type: 'gps',
    description:
      'GPS coordinates as a complex data type. Example: gps: (37.7749, -122.4194, 100.0, "2024-01-01T12:00:00Z")',
    domain: ['Vehicle', 'Drone', 'Satellite'],
    unit: 'degrees, meters',
    allowed_values: null,
    structure: {
...
export const functionTypes: FunctionTypeSchema[] = [
  ...
  },
  {
    name: 'distance',
    definition:
      'let $x_1$ be "position x"; let $y_1$ be "position y"; let $z_1$ be "position z"; let $x_2$ be "previous position x"; let $y_2$ be "previous position y"; let $z_2$ be "previous position z"; let delta_x be $x_1$ - $x_2$; let delta_y be $y_1$ - $y_2$; let delta_z be $z_1$ - $z_2$; sqrt(power(delta_x, 2) + power(delta_y, 2) + power(delta_z, 2))',
  ...
  },
  {
    name: 'displacement',
    definition:
      'let $x$ be "position x"; let $y$ be "position y"; let $z$ be "position z"; let $x_0$ be "initial position x"; let $y_0$ be "initial position y"; let $z_0$ be "initial position z"; let delta_x be $x$ - $x_0$; let delta_y be $y$ - $y_0$; let delta_z be $z$ - $z_0$; sqrt(power(delta_x, 2) + power(delta_y, 2) + power(delta_z, 2))',
    scope: ['Object', 'Particle', 'Vehicle', 'class'],
